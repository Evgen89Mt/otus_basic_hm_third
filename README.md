...
(на входе формировать строку и передавать в объект, как вариант массив слов)
2. параметр -max 42 (т.е. задать коэффициент сложности игры -m ининциализировать коэфф сложности числом 42)
3. параметр -table (игра не выполняется, вывод в консоль таблицы рекордов)
